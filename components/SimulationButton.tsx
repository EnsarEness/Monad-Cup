...
export default function SimulationButton({ groups }: { groups: { id: string, name: string }[] }) {
    ...
    const handleSimulateGroup = async () => {
        ...
        setLoading(true);
        setCurrentMatch('Simülasyon başlatılıyor...');
    ...
    return (
        <div style={{ display: 'flex', gap: '8px', alignItems: 'center', flexWrap: 'wrap' }}>
            ...
            <button
                ...
                disabled={loading || globalLoading || !selectedGroup}
                className={`${styles.actionBtn} glass-panel`}
            >
